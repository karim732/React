...
export default function WelcomePage() {
  ...
  const yCity = useTransform(scrollY, [0, 80], [0, -100]);
  ...
  const yHero = useTransform(scrollY, [0, 80], [0, -150]);

  const opacityHero = useTransform(scrollY, [0, 120, 400], [1, 1, 0]);
  const yText = useTransform(scrollY, [0, 80, 200, 400], [1, 50, 50, 300]);

  const scaleText = useTransform(scrollY, [0, 120], [1, 1.5]);
